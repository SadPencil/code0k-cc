...
namespace code0k_cc.Config
{
    class Config
    {
        public BigInteger ModulusPrimeField_Prime = BigInteger.Parse("21888242871839275222246405745257275088548364400416034343698204186575808495617", CultureInfo.InvariantCulture);
